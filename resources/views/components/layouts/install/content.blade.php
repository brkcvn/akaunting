            ...
            <div class="float-right">
                ...
                @else
                    <x-button
                        ...
                        id="next-button"
                        ::disabled="loading"
                        class="relative flex items-center justify-center bg-green hover:bg-green-700 text-white px-6 py-1.5 text-base rounded-lg disabled:bg-green-100 outline-purple sm:col-span-6"
                        override="class"
