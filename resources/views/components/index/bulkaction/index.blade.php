    ...
    <akaunting-modal
        ...
        <template #card-footer>
            <div class="flex items-center justify-end">
                <button type="button" @click="onCancelBulkAction" class="px-6 py-1.5 hover:bg-gray-200 rounded-lg ltr:mr-2 rtl:ml-2 outline-purple">
                ...
                <button type="button"
                    ...
                    class="relative flex items-center justify-center bg-green hover:bg-green-700 text-white px-6 py-1.5 text-base rounded-lg disabled:bg-green-100 outline-purple"
                >
