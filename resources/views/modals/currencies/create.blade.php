<x-form id="form-create-currency" route="modals.currencies.store">
    <div class="grid sm:grid-cols-12 gap-x-8 gap-y-6 my-3.5">
        ...
        <x-form.group.select name="code" label="{{ trans('currencies.code') }}" :options="$codes" form-group-class="col-span-12" />

        <x-form.group.text name="rate" label="{{ trans('currencies.rate') }}" @input="onChangeRate" form-group-class="col-span-12" />
