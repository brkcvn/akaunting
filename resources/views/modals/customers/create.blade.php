        ...
        <x-slot name="content">
            <x-tabs.tab id="general">
                <div class="grid sm:grid-cols-6 gap-x-8 gap-y-6 my-3.5">
                    ...
                    <x-form.group.currency without-add-new form-group-class="col-span-12" :add-new-text="trans_choice('general.currencies', 1)" />
                </div>
            </x-tabs.tab>

            <x-tabs.tab id="address">
                <div class="grid sm:grid-cols-6 gap-x-8 gap-y-6 my-3.5">
                    <x-form.group.textarea name="address" label="{{ trans('general.address') }}" form-group-class="col-span-12" rows=2 not-required />
